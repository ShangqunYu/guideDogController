...
from .depth_backbone import DepthOnlyFCBackbone58x87, RecurrentDepthBackbone
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.depth_backbone = RecurrentDepthBackbone(
            base_backbone=depth_image_compressor, 
            num_actor_obs=num_actor_obs, 
            depth_encoder_cfg={"hidden_dims": 512})
        
        # actor layers
        actor_layers = []
        actor_layers.append(nn.Linear(mlp_input_dim_a + 32, actor_hidden_dims[0]))
